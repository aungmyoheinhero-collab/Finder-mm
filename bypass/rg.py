...
"""
Edy Hacker Tool v2 - Public Free Version
...
# --- သင့်ကိုယ်ပိုင် Branding အပိုင်း ---
print("\033[32m") # အစိမ်းရောင်
print("====================================")
print("     WELCOME TO [EdyHacker] TOOL      ")
